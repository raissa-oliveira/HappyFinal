...
class MenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
            R.id.nav_home, R.id.nav_my_rep, R.id.nav_ads, R.id.nav_help, R.id.nav_sign_out), drawerLayout)
...
//
//        }
//        else if(menuItem.itemId == R.id.nav_help)
//        {
//
//        }
//        else if(menuItem.itemId == R.id.nav_sign_out)
//        {
//
//        }
